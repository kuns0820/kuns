var inc_dom = {
	...
	footer : function(){
		...
		incFR.push('</footer>');
		incFR.push('<aside>');
		incFR.push('<a href="javascript:;" data-layer="questionForm" onclick="layers(this);">1:1문의</a>');
		incFR.push('<a href="javascript:;" data-layer="questionForm" onclick="layers(this);">1:1문의</a>');
		incFR.push('</aside>');
		incFR.push('<div class="layer-wrap">');
		incFR.push('<div class="layer-conts questionForm" data-layerTYPE="fix">');
		...
		incFR.push('</div>');
		incFR.push('<a href="javascript:;" onclick="layersClose(this);" class="close"><img src="images/sub/btn_popClose.gif" alt="닫기"></a>');
		incFR.push('</div>');
		incFR.push('</div>');
