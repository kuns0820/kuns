var inc_dom = {
	header : function(){
		...
		incHD.push('<li><a href=".html">CEO인사말</a></li>');
		incHD.push('<li><a href=".html">조직 및 연락처</a></li>');
		incHD.push('<li><a href=".html">오시는길</a></li>');
		incHD.push('<li><a href=".html">CI</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li class=""><a href=".html">알림마당</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href=".html">공지사항</a></li>');
		incHD.push('<li><a href=".html">자료실</a></li>');
		incHD.push('<li><a href=".html">FAQ</a></li>');
		incHD.push('<li><a href=".html">Q&A(1:1)</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li class=""><a href=".html">채용정보</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href=".html">채용공고</a></li>');
		incHD.push('<li><a href=".html">채용문의</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li class=""><a href=".html">직원전용</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href=".html">업무공지</a></li>');
		incHD.push('<li><a href=".html">보고자료</a>');
		incHD.push('<ul>');
		incHD.push('<li><a href=".html"><i>-</i> 근태자료</a></li>');
		incHD.push('<li><a href=".html"><i>-</i> 교육자료</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li><a href=".html">노조게시판<br />(노조회원 전용)</a></li>');
