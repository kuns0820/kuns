var inc_dom = {
	header : function(){
		...
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li><a href="business01.html">BUSINESS</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href="business01.html">화학사업</a></li>');
		incHD.push('<li><a href="business02.html">장비사업</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li><a href="manufacture01.html">MANUFACTURE</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href="manufacture01.html">공장</a></li>');
		incHD.push('<li><a href="manufacture02.html">품질</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
