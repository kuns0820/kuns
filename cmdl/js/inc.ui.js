var inc_dom = {
	header : function(){
		...
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li><a href="business01.html">장비사업</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href="equipment.html">Introduction</a></li>');
		...
		incHD.push('<li><a href="equipment08.html">Contact</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li><a href="manufacture01.html">화학사업</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href="manufacture.html">Introduction</a></li>');
		incHD.push('<li><a href="manufacture01.html">OEM</a></li>');
		incHD.push('<li><a href="manufacture02.html">공정개발</a></li>');
		incHD.push('<li><a href="manufacture03.html">공장</a></li>');
		incHD.push('<li><a href="manufacture04.html">품질관리</a></li>');
		incHD.push('<li><a href="manufacture05.html">분석시설</a></li>');
		incHD.push('<li><a href="manufacture06.html">소자평가</a></li>');
		incHD.push('<li><a href="manufacture07.html">Contact</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
