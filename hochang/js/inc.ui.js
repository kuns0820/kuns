var inc_dom = {
	header : function(){
		...
		incHD.push('<ul>');
		incHD.push('<li><a href="company01.php">호창 HOchang</a>');
		incHD.push('<div class="dep2">');
		incHD.push('<ul>');
		incHD.push('<li><a href="company01.php">인사말</a></li>');
		incHD.push('<li><a href="company02.php">연혁</a></li>');
		incHD.push('<li><a href="company03.php">조직도</a></li>');
		incHD.push('<li><a href="company04.php">인증현황&특허</a></li>');
		incHD.push('<li><a href="company05.php">오시는길</a></li>');
		incHD.push('</ul>');
		incHD.push('</div>');
		incHD.push('</li>');
		incHD.push('<li><a href="car01.php">자동차부품사업부</a>');
		incHD.push('<div class="dep2">');
		incHD.push('<ul>');
		incHD.push('<li><a href="car01.php">제조공법 흐름도</a></li>');
		incHD.push('<li><a href="car02.php">제조공정</a></li>');
		incHD.push('<li><a href="car03.php">설비&측정 설비현황</a></li>');
		incHD.push('<li><a href="car04.php">제품소개</a></li>');
		incHD.push('<li><a href="car05.php">R&D 현황</a></li>');
		incHD.push('</ul>');
		incHD.push('</div>');
		incHD.push('</li>');
		incHD.push('<li><a href="build01.php">건설자재사업부</a>');
		incHD.push('<div class="dep2">');
		incHD.push('<ul>');
		incHD.push('<li><a href="build01.php">제품소개</a></li>');
		incHD.push('<li><a href="build02.php">시험성적서</a></li>');
		incHD.push('<li><a href="build03.php">동영상</a></li>');
		incHD.push('<li><a href="build04.php">견적문의</a></li>');
		incHD.push('</ul>');
		incHD.push('</div>');
		incHD.push('</li>');
		incHD.push('<li><a href="bio01.php">바이오사업부</a>');
		incHD.push('<div class="dep2">');
		incHD.push('<ul>');
		incHD.push('<li><a href="bio01.php">Strategy</a></li>');
		incHD.push('<li><a href="bio02.php">R&D</a></li>');
		incHD.push('<li class="sub"><a href="bio02.php">Biotechnology</a></li>');
		incHD.push('<li class="sub"><a href="bio3.php">Biocosmetics</a></li>');
		incHD.push('<li><a href="bio04.php">Products</a></li>');
		incHD.push('</ul>');
		incHD.push('</div>');
		incHD.push('</li>');
		incHD.push('</ul>');
	...
	footer : function(){
		...
		incFR.push('<a href="sitemap.php" class="btn_sitemap">사이트맵</a>');
		incFR.push('</footer>');
