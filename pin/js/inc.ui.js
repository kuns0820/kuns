var inc_dom = {
	header : function(){
		...
		incHD.push('<h1 class="logo"><a href=""><img src="images/logo.png" alt="PIN"></a></h1>');
		incHD.push('<div class="gnb_wrap">');
		incHD.push('<ul>');
		incHD.push('<li><a href="">회사소개</a>');
		incHD.push('<ul class="dep2">');
		incHD.push('<li><a href="">Company Overview</a></li>');
		incHD.push('<li><a href="">Our Platform Technology</a></li>');
		incHD.push('<li><a href="">Team Structuring</a></li>');
		incHD.push('</ul>');
		incHD.push('</li>');
		incHD.push('<li><a href="">프로젝트</a></li>');
		incHD.push('<li><a href="">공지</a></li>');
		incHD.push('<li><a href="">채용</a></li>');
		incHD.push('</ul>');
		incHD.push('</div>');
		...
		incHD.push('<p class="logo"><a href=""><img src="images/logo_all.png" alt="PIN"></a></p>');
	...
	footer : function(){
		...
		incFR.push('<li><a href="">회사소개</a></li>');
		incFR.push('<li><a href="">프로젝트</a></li>');
		incFR.push('<li><a href="">공지</a></li>');
		incFR.push('<li><a href="">채용</a></li>');
		incFR.push('</ul>');
